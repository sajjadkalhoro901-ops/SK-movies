/* SK Movies anime episode browser. Uses official/legal source searches only; it does not host or bypass copyrighted streams. */
(function(){
  const CONFIG={
    'Naruto':{count:220,channel:'VIZ',search:'site:youtube.com/@vizmedia Naruto Episode'},
    'Naruto: Shippuden':{count:500,channel:'VIZ',search:'site:youtube.com/@vizmedia Naruto Shippuden Episode'},
    'One Piece':{count:0,channel:'Crunchyroll',search:'site:youtube.com/@Crunchyroll One Piece full episode'},
    'Demon Slayer: Kimetsu no Yaiba':{count:55,channel:'Crunchyroll',search:'site:youtube.com/@Crunchyroll Demon Slayer full episode'},
    'Jujutsu Kaisen':{count:47,channel:'Crunchyroll',search:'site:youtube.com/@Crunchyroll Jujutsu Kaisen full episode'},
    'Death Note':{count:37,channel:'VIZ',search:'site:youtube.com/@vizmedia Death Note episode'},
    'Hunter x Hunter':{count:148,channel:'VIZ',search:'site:youtube.com/@vizmedia Hunter x Hunter episode'}
  };
  const posterMap={
