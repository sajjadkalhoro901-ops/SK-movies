...
(function(){
  ...
  load('site-core.js').then(()=>load('poster-fixes.js')).then(()=>load('anime-player.js')).then(()=>load('test-player.js')).then(()=>load('series-links.js')).then(()=>load('final-fixes.js')).catch(()=>{});
})();
