/* SK Movies — dedicated legal/open cartoon & animation page */
(function(){
  const cartoons=[
    {title:'Big Buck Bunny',emoji:'🐰',source:'https://commondatastorage.googleapis.com/gtv-videos-bucket/sample/BigBuckBunny.mp4',license:'Blender Foundation • Creative Commons'},
    {title:'Sintel',emoji:'🐉',source:'https://commondatastorage.googleapis.com/gtv-videos-bucket/sample/Sintel.mp4',license:'Blender Foundation • Creative Commons'},
